...
export class UploadIcon extends React.Component<Props> {
    render() {
        const { width = '3.2rem', height = '3.2rem', className } = this.props;
        return (
            <svg
                className={className}
                width={width}
...
export class MessageIcon extends React.Component<Props> {
    render() {
        const { width = '2.6rem', height = '2.6rem', className } = this.props;
        return (
            <svg
                className={className}
                width={width}
...
export class InboxIcon extends React.Component<Props> {
    render() {
        const { width = '3.2rem', height = '3.2rem', className } = this.props;
        return (
            <svg
...
export class CheckIcon extends React.Component<Props> {
    render() {
        const { width = '1.4rem', height = '1.4rem', className } = this.props;
        return (
            <svg
                className={className}
                width={width}
...
export class BackIcon extends React.Component<Props> {
    render() {
        const { width = '2rem', height = '2rem', className } = this.props;
        return (
            <svg
                className={className}
                width={width}
...
export class CoinIcon extends React.Component<Props> {
    render() {
        const { width = '2rem', height = '2rem', className } = this.props;
        return (
            <svg
...
export class FeedbackIcon extends React.Component<Props> {
    render() {
        const { width = '2rem', height = '2rem', className } = this.props;
        return (
            <svg
...
export class LanguageIcon extends React.Component<Props> {
    render() {
        const { width = '2rem', height = '2rem', className } = this.props;
        return (
            <svg
...
export class SettingIcon extends React.Component<Props> {
    render() {
        const { width = '2rem', height = '2rem', className } = this.props;
        return (
            <svg
...
export class KeyboardIcon extends React.Component<Props> {
    render() {
        const { width = '2rem', height = '2rem', className } = this.props;
        return (
            <svg
...
export class LogoutIcon extends React.Component<Props> {
    render() {
        const { width = '2rem', height = '2rem', className } = this.props;
        return (
            <svg
...
export class SearchIcon extends React.Component<Props> {
    render() {
        const { width = '2.4rem', height = '2.4rem', className } = this.props;
        return (
            <svg
                className={className}
                width={width}
...
export class Loading extends React.Component<Props> {
    render() {
        const { width = '1.6rem', height = '1.6rem', className } = this.props;
        return (
            <svg
                className={className}
                width={width}
...
export class CircleX extends React.Component<Props> {
    render() {
        const { width = '1.6rem', height = '1.6rem', className } = this.props;
        return (
            <svg
...
export class HomeIcon extends React.Component<Props> {
    render() {
        const { width = '3.2rem', height = '3.2rem', className } = this.props;
        return (
            <svg
...
export class HomeActiveIcon extends React.Component<Props> {
    render() {
        const { width = '3.2rem', height = '3.2rem', className } = this.props;
        return (
            <svg
...
export class UserGroupIcon extends React.Component<Props> {
    render() {
        const { width = '3.2rem', height = '3.2rem', className } = this.props;
        return (
            <svg
...
export class UserGroupActiveIcon extends React.Component<Props> {
    render() {
        const { width = '3.2rem', height = '3.2rem', className } = this.props;
        return (
            <svg
...
export class LiveIcon extends React.Component<Props> {
    render() {
        const { width = '3.2rem', height = '3.2rem', className } = this.props;
        return (
            <svg
...
export class LiveActiveIcon extends React.Component<Props> {
    render() {
        const { width = '3.2rem', height = '3.2rem', className } = this.props;
        return (
            <svg
